...
<head>
    ...
    <title>دوربین هوشمند تشخیص حرکت</title>
    <style>
        body { 
...
<body>
    ...
    <div class="controls">
        <!-- ردیف اول: اسلایدر حساسیت -->
        <div class="row">
            <label>حساسیت (<span id="sensVal">20</span>):</label>
            <input type="range" id="sensitivity" min="5" max="100" value="20">
        </div>

        <!-- ردیف دوم: نوار سبز رنگ (موشن بار) -->
        <div>
            <div class="row" style="margin-bottom: 2px;">
                <label style="font-size: 12px; color: #888;">میزان حرکت:</label>
            </div>
        ...
        <!-- ردیف سوم: دکمه‌ها (دوربین + آژیر) -->
        <div class="row">
            <!-- دکمه تغییر دوربین که حذف شده بود -->
    ...
    <script>
        ...
        let currentFacingMode = 'environment'; // دوربین پشت پیش‌فرض
        let stream = null;
        ...
        async function startCamera() {
            ...
            try {
                // درخواست دوربین با facingMode متغیر
                ...
                statusEl.innerText = "خطا در دسترسی به دوربین";
            }
        }
        ...
        function toggleSiren() {
            initAudio(); // فعال‌سازی Context با کلیک کاربر
...
try:
    ...
    print("✅ فایل دوربین اصلاح شد: دکمه تغییر دوربین و نوار حرکت بازگشتند + آژیر فعال است.")
