...
<body>
    ...
    <div class="control-panel">
        ...
        <!-- گراف حرکت با خط کش و خط آستانه -->
        ...
        <!-- اعداد دقیق -->
        <div class="stats-row">
            <span class="stat-item text-red">آستانه: <span id="threshText">50</span></span>
